...
// async function quickstart( imgObj) {
...
//     // const [result] = await client.labelDetection('./pages/demo3.png');
...
//     const [result] = await client.textDetection(imgObj);
...
// let anss = []
// var num=0
// // detections.forEach(text => console.log(num+" gap "+text.description); num=num+1;);
...
//     throw error; // You might want to handle or log the error depending on your needs
//   }
// }


// var gg = await quickstart('cutie');
